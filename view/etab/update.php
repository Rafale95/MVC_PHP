...
?>
    ...
    <div class="container w-50" style="border: #0a53be 2px solid; border-radius: 40px">
        <div class="mb-3 row">
            ...
            <label for="input_etab" class="text-light col-sm-3 col-form-label">Niveau</label>
            <div class="col-sm-7">
        ...
        <p></p>
        <div class="mb-3 row">
            <label for="input_anSco" class="text-light col-sm-3 col-form-label">Identifiant</label>
            <div class="col-sm-7">
