...
?>
    ...
    ?>
    <div>
        <h3 class="text-light fs-2 text-center">Création de la classe</h3>
    </div>
    <form method="post">
        ...
        <div class="container w-50" style="border: #0a53be 2px solid; border-radius: 40px">
            <div class="mb-3 row">
                ...
                <label for="input_niv" class="text-light col-sm-3 col-form-label">Niveau scolaire</label>
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input_niv" name="input_niv" required maxlength="1">
                </div>
            </div>
            <p></p>
            <div class="mb-3 row">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" id="input_ident" name="input_ident" required maxlength="3">
                </div>
            </div>
